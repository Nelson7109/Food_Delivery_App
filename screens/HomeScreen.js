    ...
    return (
      <KeyboardAvoidingView style={{ flex: 1, marginTop: 25 }}>
        <ScrollView style={{ flex: 1 }}>
          <SafeAreaView>
           <Text style={styles.title}>EatIt</Text>
...
const styles = StyleSheet.create({
  title:{
    color: '#FF3333', // Zomato red color
    fontSize: 40, // Adjust font size as needed
    fontWeight: 'bold', // For a bolder look
    textAlign: 'center', // Center the text
    width: '100%', // Full width
    fontFamily: 'Roboto', // Zomato uses Roboto
    letterSpacing: 2, // Space letters for a wider look
